...
At this point, you are free to make changes to your local code code in your laptop. Don't worry if you mess things up, it's no problem to add mistakes to a branch.
...
If a MONET run is suddenly interrupred or if the expected outputs has note been generated, here are few common problems that can occur:
