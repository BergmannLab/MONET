...
# R1 - CAUSALITY
monet --input=./input/zachary_karate_club_100.txt --output=$output --method=R1 --container=docker

# M1 - ALEPH
monet --input=./input/zachary_karate_club_100.txt --output=$output --method=M1 --container=docker

# K1 - TUSK
monet --input=./input/zachary_karate_club_100.txt --output=$output --method=K1 --container=docker
